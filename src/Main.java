...
public class Main {
    ...
    case "2":
        ...
        System.out.println("¿Cual es tu nombre?");
        String nomj0 = scanner.nextLine();
        JOptionPane.showMessageDialog(null, "¡¡Bienvenido/a " + nomj0 + "!!");
            break;
    case "3":
        int primerNum = 2;
        int segundoNum = 4;
    ...
    case "8":
        ...
        case "13":
                  System.out.println("Ingrese un numero: ");
                  int numPrimo = Integer.parseInt(scanner.nextLine());
            for (int i = 3; i <= Math.sqrt(numPrimo); i += 2)
                break;
        case "14":
